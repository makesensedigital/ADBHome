...
(function () {
  ...
  // ---------------------------------------------------------------- the container
  // A CONTAINER IS NOT A MEASUREMENT: this delivers events, and something on the other side has
  // to receive them. Nothing in this file can see whether anything does, which is why the
  // destination is named in config.js and attested there — `check-config.mjs` fails on it (§26).
